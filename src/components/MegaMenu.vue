...
// Allows the menu to close when a link is clicked (especially for mobile)
const emit = defineEmits(['close']);
</script>

<template>
  <div class="dropdown-menu mega-menu w-100 shadow-lg border-0 mt-0 bg-navy">
     <div class="container py-4">
        <div class="row g-4">
           
<div class="col-lg-4 mb-3 mb-lg-0">
    <h6 class="text-gold fw-bold text-uppercase border-bottom border-gold pb-2 mb-3">About Us</h6>
    <ul class="list-unstyled">
        <li><router-link class="mega-link" to="/about" @click="$emit('close')">Who We Are</router-link></li>
        
        <li><router-link class="mega-link" to="/#mission" @click="$emit('close')">Our Mission & Vision</router-link></li>
        
        <li><router-link class="mega-link" to="/about#leadership" @click="$emit('close')">Leadership Team</router-link></li>
    </ul>
</div>
           ...
           <div class="col-lg-4 mb-3 mb-lg-0">
              ...
              <ul class="list-unstyled">
                 <li><router-link class="mega-link" to="/focus/job-market" @click="$emit('close')">Job Market Analysis</router-link></li>
                 <li><router-link class="mega-link" to="/focus/curriculum" @click="$emit('close')">Curriculum Development</router-link></li>
                 <li><router-link class="mega-link" to="/focus/ai-tools" @click="$emit('close')">AI Tool Adoption</router-link></li>
           ...
           <div class="col-lg-4">
              <h6 class="text-gold fw-bold text-uppercase border-bottom border-gold pb-2 mb-3">Connect With Us</h6>
              <p class="small text-white-50 mb-4 pe-lg-4">
                  Stay updated with our latest insights, case studies, and corporate news across our platforms.
              </p>
...
.border-gold { border-color: rgba(190, 164, 41, 0.4) !important; }

/* The white text links with hover effect */
.mega-link {
    display: block; 
...
.social-icon {
  ...
  border: 1px solid rgba(190, 164, 41, 0.2);
}
.social-icon:hover {
...
@media (max-width: 991px) {
    .mega-menu { 
        ...
        margin-top: 10px; 
        border-radius: 8px;
        background: rgba(255,255,255,0.02) !important; /* Blends into mobile menu */
    }
}
</style>